...
export class CommentService {
  ...
  url:string ="http://localhost:9090/comment";
  url2:string="http://localhost:9090/filtercomment"
  ...
  updateComment(data:any){
    ...
    return this.http.put<any>("http://localhost:9090/editcomment/"+id+"/"+msg, null)
    .pipe(map((res:any)=>{
      return res;
    }))
  }
  ...
  updateComment2(data:any, id:number){
    return this.http.put<any>("http://localhost:9090/updatecomment/"+id, data)
    .pipe(map((res:any)=>{
      return res;
    }))
  }
  ...
  deleteComment(id:any){
    return this.http.delete<any>("http://localhost:9090/deletecomment/"+id)
    .pipe(map((res:any)=>{
      return res;
    }))
  }
