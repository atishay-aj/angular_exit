...
export class ApiService {
  ...
  baseUrl:string ="http://localhost:9090/questions";

  urlQsn:string ="http://localhost:9090/questions";

  urlSearch:string ="http://localhost:9090/search";

  urlAllUsers:string ="http://localhost:9090/allusers";

  urlQsnByEmail:string ="http://localhost:9090/filterbyemail";
  ...
  // postUsers(data:any){
  //   return this.http.post<any>("http://localhost:9090/users", data)
  //   .pipe(map((res:any)=>{
  //     return res;
  //   }))
  // }
